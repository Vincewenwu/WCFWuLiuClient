...
{
    public partial class FRM_RiQiWangDianTongJi : Form
    {
        public FRM_RiQiWangDianTongJi()
        {
            InitializeComponent();
        }

        private void FRM_RiQiWangDianTongJi_Load(object sender, EventArgs e)
        {
            ...
            CRP_RiQiWangDianTongJi myCRP_RiQiWangDianTongJi = new CRP_RiQiWangDianTongJi();
            myCRP_RiQiWangDianTongJi.SetDataSource(myDS_WuLiu);
            crystalReportViewer1.ReportSource = myCRP_RiQiWangDianTongJi;
        }
    }
}
